...
const ContextMenuDemo = () => {
  ...
  return (
    <ContextMenu.Root>
       <ContextMenu.Trigger className="flex-inline text-xs p-1 border border-black"> {/*className="block border-2 border-white border-dashed text-white rounded text-[15px] select-none py-[10px] w-[300px] text-center"> */}
          MENU
      </ContextMenu.Trigger>
      <ContextMenu.Portal>
        <ContextMenu.Content
